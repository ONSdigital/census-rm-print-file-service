...
ACTION_TYPE_TO_PRINT_TEMPLATE = {
    ...
    # RERUN IC TYPES
    ActionType.ICL1E_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.ICL2W_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.ICL4N_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.ICHHQE_RERUN: PrintTemplate.QM_QUESTIONNAIRE_TEMPLATE,
    ActionType.ICHHQW_RERUN: PrintTemplate.QM_QUESTIONNAIRE_TEMPLATE,
    ActionType.ICHHQN_RERUN: PrintTemplate.QM_QUESTIONNAIRE_TEMPLATE,
    ActionType.CE1_IC01_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.CE1_IC02_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.SPG_IC11_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.SPG_IC12_RERUN: PrintTemplate.PPO_LETTER_TEMPLATE,
    ActionType.SPG_IC13_RERUN: PrintTemplate.QM_QUESTIONNAIRE_TEMPLATE,
    ActionType.SPG_IC14_RERUN: PrintTemplate.QM_QUESTIONNAIRE_TEMPLATE,
}
